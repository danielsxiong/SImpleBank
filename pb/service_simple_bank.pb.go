...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto\x1a\x15rpc_update_user.proto\x1a\x16rpc_verify_email.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xd8\x04\n" +
	"\n" +
	"SimpleBank\x12\x95\x01\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"X\x92AA\x12\x0fCreate new User\x1a.Create new User with name, email, and password\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/users\x12\x87\x01\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"M\x92A0\x12\n" +
	"Login User\x1a\"Login User with email and password\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/users/login\x12\x8f\x01\n" +
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"R\x92A;\x12\vUpdate User\x1a,Update User's full name, email, and password\x82\xd3\xe4\x93\x02\x0e:\x01*\x1a\t/v1/users\x12\x95\x01\n" +
	"\vVerifyEmail\x12\x16.pb.VerifyEmailRequest\x1a\x17.pb.VerifyEmailResponse\"U\x92A:\x12\fVerify Email\x1a*Verify email with email id and secret code\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/verify_emailBk\x92AL\x12J\n" +
	"\x0eSimpleBank API\"3\n" +
	"\x05Xiong\x12*https://github.com/danielsxiong/SImpleBank2\x031.2Z\x1adanielsxiong/simplebank/pbb\x06proto3"
